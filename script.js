...
const revealSelector = '.section,.card,.role-card,.application-flow li,.application-form,.product-card,.order-card,.location-card,.photo-block,.map,.poster-row img,.notice,.feature-card,.location-preview,.menu-showcase,.accent-card';
